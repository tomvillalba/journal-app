		...
		<div>
			<div>
				<button
					...
					className="navbar-burger cursor-grab flex items-center text-primary dark:text-primary-dark p-1 lg:p-3 hover:rotate-90 transition-all">
					<svg
			...
			<div
				...
				<div
					onClick={handleActiveMenu}
					className="navbar-backdrop cursor-grabbing fixed inset-0 bg-gray-800 opacity-25 "></div>
				<nav
					...
					<div className="flex items-center mb-8">
						...
						<button
							...
							<svg
								className="h-6 w-6 text-gray-400 cursor-grabbing hover:text-gray-500"
								xmlns="http://www.w3.org/2000/svg"
								fill="none"
								viewBox="0 0 24 24"
								stroke="currentColor">
